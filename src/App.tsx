...
export default function App() {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-slate-50 text-slate-900 font-sans antialiased relative selection:bg-blue-100 selection:text-blue-900">
      ...
      {isMobileSidebarOpen && (
        <div className="fixed inset-0 z-50 flex md:hidden">
          ...
          <Sidebar
            ...
            className="relative z-10 w-72 bg-white border-r border-slate-200 shadow-xl"
          />
        </div>
      )}
