...
export const DEMO_STORAGE_ACCOUNTS: StorageAccount[] = [
  {
    ...
    providerAccountId: 'google-sub-1049281',
  ...
  },
  {
    ...
    userId: 'user-001',
    provider: ProviderType.GOOGLE_DRIVE,
    providerAccountId: 'google-sub-2098412',
    email: 'alex.workspace@gmail.com',
    displayName: 'Consulting & Work Drive',
  ...
  },
  {
    ...
    userId: 'user-001',
    provider: ProviderType.GOOGLE_DRIVE,
    providerAccountId: 'google-sub-3981023',
    email: 'alex.media.vault@gmail.com',
    displayName: 'Photography & Raw Media',
