    ...
    <div id="settings-view" className="space-y-6 max-w-4xl mx-auto pb-12">
      ...
      <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-xs space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <h2 className="text-sm font-semibold text-slate-900 dark:text-slate-100">Upload Routing Policy</h2>
            <p className="text-xs text-slate-500 dark:text-slate-400">Configure file distribution policies across connected Google Drive accounts</p>
          </div>
        </div>
          ...
          {[
            ...
            <div
              ...
              className={`p-4 rounded-xl border cursor-pointer transition-all space-y-2 ${
                strategy === item.id
                  ? 'border-blue-600 bg-blue-50/60 dark:bg-blue-950/40 shadow-2xs'
                  : 'border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800/60 hover:border-slate-300 dark:hover:border-slate-700'
              }`}
            >
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`h-3.5 w-3.5 rounded-full border flex items-center justify-center ${
                    strategy === item.id ? 'border-blue-600 bg-blue-600 dark:border-blue-500 dark:bg-blue-500' : 'border-slate-300 dark:border-slate-600'
                  }`}
                >
      ...
      <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-xs space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-sm font-semibold text-slate-900 dark:text-slate-100">Security &amp; Token Encryption</h2>
            <p className="text-xs text-slate-500 dark:text-slate-400">Zero-client exposure architecture and data encryption at rest</p>
          </div>
        </div>

        <div className="space-y-3 pt-2 text-xs">
          <div className="flex items-start gap-3 p-3.5 rounded-lg bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700">
            <Lock className="h-4 w-4 text-emerald-600 dark:text-emerald-400 shrink-0 mt-0.5" />
            <div>
              <p className="font-semibold text-slate-900 dark:text-slate-100">AES-256-GCM Encryption Engine</p>
          ...
          <div className="flex items-start gap-3 p-3.5 rounded-lg bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700">
            ...
            <div>
              <p className="font-semibold text-slate-900 dark:text-slate-100">Zero-Client Token Exposure</p>
              <p className="text-slate-500 dark:text-slate-400 mt-0.5 leading-relaxed">
      ...
      <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-xs space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-sm font-semibold text-slate-900 dark:text-slate-100">Database &amp; Infrastructure</h2>
            <p className="text-xs text-slate-500 dark:text-slate-400">PostgreSQL connection readiness and server environment</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 text-xs">
          <div className="p-3.5 rounded-lg bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 space-y-1">
            <p className="text-slate-500 dark:text-slate-400 font-medium">Database Target</p>
            <p className="font-semibold text-slate-900 dark:text-slate-100">PostgreSQL (Connected)</p>
            <p className="text-[11px] text-slate-400 dark:text-slate-500">Virtual metadata catalog store</p>
          </div>

          <div className="p-3.5 rounded-lg bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 space-y-1">
            <p className="text-slate-500 dark:text-slate-400 font-medium">Server Runtime</p>
            <p className="font-semibold text-slate-900 dark:text-slate-100">UniCloud Engine</p>
            <p className="text-[11px] text-slate-400 dark:text-slate-500">Secure API Proxy</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-end pt-2">
        <button
          onClick={handleSave}
          className="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white font-medium rounded-lg text-xs shadow-xs transition-colors cursor-pointer"
        >
          Save Preferences
        </button>
      </div>
